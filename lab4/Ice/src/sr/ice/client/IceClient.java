...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base1 = communicator.stringToProxy("calc/calc33:tcp -h 192.168.43.208 -p 10000 -z : udp -h 192.168.43.208 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości
			ObjectPrx base2 = communicator.stringToProxy("calc/calc22:tcp -h 192.168.43.208 -p 10000 -z : udp -h 192.168.43.208 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości
